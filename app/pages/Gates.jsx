  ...
  return (
    ...
    >
      ...
      <div className="mt-10">
        <CodeFillBlank
          title="Reach |-⟩ From |+⟩"
          prompt="qc.h(0) already turned |0⟩ into |+⟩. Which line reaches |-⟩ next?"
          visual={<StateTransition from="|+⟩" to="|-⟩" />}
          before={['qc = QuantumCircuit(1)', 'qc.h(0)      # |0⟩ → |+⟩']}
          choices={['qc.z(0)', 'qc.x(0)', 'qc.s(0)', 'qc.h(0)']}
          correctIndex={0}
          explanation="Z|+⟩ = |-⟩ (Section 3). X leaves |+⟩ unchanged; S lands on |i+⟩; a second H returns to |0⟩."
        />
      </div>
