  ...
  return (
    <div className="rounded-xl overflow-hidden border border-slate-800">
      <div className="flex items-center justify-between bg-slate-900 px-4 py-2.5 border-b border-slate-800">
        ...
        <button
          onClick={copy}
          className="flex items-center gap-1.5 px-2.5 py-2 -my-0 sm:px-2 sm:py-1 sm:-my-0.5 rounded-lg text-xs text-slate-500 hover:text-slate-200 transition-colors
