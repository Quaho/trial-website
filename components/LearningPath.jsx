...
const STEPS = [
  { id: 'intuition', label: 'Intuition', to: '/intuition' },
  { id: 'braket',    label: 'Bra-Ket',   to: '/braket' },
  { id: 'phase',     label: 'Phase',     to: '/phase' },
  { id: 'qiskit',    label: 'Qiskit',    to: '/qiskit' },
]
          ...
          >
            <div className={`w-10 h-10 rounded-full flex items-center justify-center border-2 transition-all
                             ${completed[step.id]
                               ...
                               : 'border-slate-600 bg-slate-800/40 text-slate-300 group-hover:bg-slate-700/50'}`}>
              {completed[step.id]
